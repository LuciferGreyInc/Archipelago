...
# EarthBound_TODO: Find the EarthBound US hash
...
# EarthBound_TODO: Edit all memory locations for EarthBound
level_unlock_map = {
    0x657: [0x65A],
...
# EarthBound_TODO: Rewrite to patch the EarthBound ROM
# Dependencies Rules & Options
